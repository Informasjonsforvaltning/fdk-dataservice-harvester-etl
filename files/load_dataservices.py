...
with open(args.outputdirectory + 'dataservices_transformed.json') as transformed_file:
    ...
    for mongo_id in transformed_json:
        ...
        print(db.dataserviceMeta.find_one_and_update({'_id': mongo_id},  {'$set': to_be_updated}))
